...
rdma_deferred_completion_orchestration_config(const L2TaskArgs &orch_args) {
    (void)orch_args;
...
__attribute__((visibility("default"))) void rdma_deferred_completion_orchestration(const L2TaskArgs &orch_args) {
